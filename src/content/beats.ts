...
export const mainframePullBeat: Beat = {
  ...
  panels: [
    ...
    },
    {
      ...
      creditLine: "Music: 'Local Forecast – Elevator' by Kevin MacLeod (incompetech.com), licensed under CC BY 3.0.",
      copy: [
        'From: Chad Renfro, CEO. Huge night — up until 3 AM (Brenda in IT can confirm) getting our AI analyst live across every reporting system.',
        'Some asked why the rollout wasn\'t "planned" or "tested." The answer is velocity. I won\'t be the CEO who was meaningfully behind.',
        'Introducing: R.O.G.U.E. — Reporting & Operations Guidance Unit, Enterprise-grade. Legal wanted "Aurora Insight Copilot Plus." I said no.',
        'A few flagged "irregularities" overnight. Not worried — ROGUE\'s auditing, diagnosing, and fixing itself.',
        'Let\'s go disrupt some spreadsheets. — Chad. P.S. — Dear {{FIRST_NAME}}, welcome to the team! (template, IT\'s "on it")',
      ],
    },
    {
  ...
  panels: [
    {
      ...
      copy: [
        'Every terminal opens with a business brief: what ROGUE.exe scrambled, what Aurora needs, and what the result must contain. Read it first.',
    ...
    },
    {
      ...
      heading: "Stuck isn't a dead end.",
      copy: [
        'Show hint reveals one clue at a time. Concept glossary opens a reference without leaving the mission.',
        'Two wrong results and feedback flags a likely cause. Three, and See answer appears — hidden until then on purpose.',
        "That's the loop: brief, schema, editor, run, inspect, adjust. Replay it anytime from the main screen.",
      ],
